...
# Lyrion Contributor License Agreement (CLA)

This Agreement is for your protection as a Contributor and for the protection of Lyrion and its users. It does not affect your rights to use your own Contributions for other purposes.

*Thank you for your interest in contributing to our open source software projects ("Projects"). This Contributor License Agreement ("Agreement") sets out the terms governing any source code, object code, bug fixes, configuration changes, tools, specifications, documentation, data, materials, feedback, information, or other works of authorship that you submit or have submitted in any form or manner to Lyrion ("Lyrion", "we", or "us") with respect to the Projects (collectively, "Contributions").*
...
* Changing the license may be necessary, for example, if the license is incompatible with a larger combined work, we want to lift some restrictions of the GPL, or it turns out that someone is abusing the existing license in ways we don't yet know about.
...
* If you have any questions about this Agreement, please contact us at [lyrion.org/contact](contact.md).
...
*No Obligation*. You acknowledge that Lyrion is under no obligation to use or incorporate your Contributions into any of the Projects. The decision to use or incorporate your Contributions into any of the Projects will be made at the sole discretion of Lyrion or its authorized delegates.
...
*Assignment*. You agree that Lyrion may assign this Agreement, and all of its rights, obligations and licenses hereunder.
...
I hereby agree to this Contributor License Agreement (CLA), and these terms shall apply to all my past, present, and future Contributions.
